...
export default function Employees() {
  ...
  return (
    <div className="w-full h-min-screen pr-10 pl-10">
      ...
      <div className="mt-5 flex justify-between" id="di">
        ...
        <div>
          ...
          >
            <Box sx={style}>
              <div className="flex justify-end">
                <img src="icons/cross69.svg" className="cursor-pointer" onClick={giftAllEmCl} alt="" />
              </div>
          ...
          >
            <Box sx={style3}>
              <div className="flex justify-end">
                <img src="icons/cross69.svg" className="cursor-pointer" onClick={addEmCl} alt="" />
              </div>
              <h3 className="text-center mt-6" style={{ color: '#25384D', fontWeight: '700' }}>
                AddAnEmployee
              </h3>
              <div className="w-full my-5 border border-gray-400 border-dashed p-4 rounded-lg text-center">
                <img src="icons/CSV_file.svg" alt="" className="m-auto mb-3" />
            ...
            <div className="flex justify-center mt-4">
                  ...
                  {/* <div className="">
                    ...
                    >
                      <span className="contents">
                        Send Invite
                        &nbsp;<img src="icons/chevron_right.svg" style={{ filter: 'brightness(300%)' }} alt="right_arrow"></img>
                      </span>
                    </Button>
                  </div> */}
                </Form>
              ...
              {/* <div className="mt-4 flex flex-col">
                ...
                <div className=" relative">
                  ...
                  />
                  <img src="icons/search.svg" alt="" className="absolute bottom-4 right-2 cursor-pointer" />
                </div>
              </div>
              <div className="flex justify-end mt-3">
                <img src="icons/add_1.svg" className="mx-2" />
