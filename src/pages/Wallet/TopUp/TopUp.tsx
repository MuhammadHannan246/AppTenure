...
const [activeBank, setactiveBank] = useState("");
  ...
  return (
    ...
    <div className='flex text-start ms-4 mt-5'>
      <img src="icons/arrow_left.svg" onClick={()=>navigate('/wallet')} className='mr-4 cursor-pointer' alt="" />
    ...
    <div className='w-full ms-5'>
        ...
        <div className={`rounded-xl cursor-pointer  border-4 pl-2 py-2 ${active==='card' && 'border-primary-400'}`} style={{width:'6%',}} onClick={()=>setActive('card')}>
            <img src={`icons/${active==='card'?'wallet_1.svg':'wallet_1.svg'}`} alt="" />
            <p className='text-start text-gray mt-3'>Card</p>
        </div>
        <div className={`rounded-xl cursor-pointer border-4 pl-2 py-2 ${active === 'bank' && 'border-primary-400'}`} style={{width:'6%',}} onClick={()=>setActive('bank')}>
            <img src={`icons/${active==='bank'?'bank_2.svg':'bank_1.svg'}  `} alt="" />
            <p className='text-start text-primary-600 mt-3'>Bank</p>
        </div>
        </div>
...
{  active==='card' && 
     ...
     <form className='flex flex-col mt-9' style={{width:"95%"}}onSubmit={formik.handleSubmit}>
        ...
        <div className='flex justify-end mt-5 w-full'>
          ...
          <button type="submit" className='p-2 rounded-md cursor-pointer' style={{ backgroundColor: "#38857B", color: "white", fontWeight: "600" }}>Top Up Wallet</button>
        </div>
        </form>)
    }

{
    ...
    <form className='flex flex-col mt-9' style={{ width: "95%" }} onSubmit={formik2.handleSubmit}>
                    ...
                    style={{ border: formik2.touched.amount && formik2.errors.amount ? '1px solid red' : '' }}
                      ...
                      <FormControl sx={{ width: '100%', marginLeft: 0, marginTop: 2 }}>
                          ...
                          >
                              <MenuItem value="Bank of Canada" onClick={()=>{setactiveBank("Canada")}}>Bank of Canada</MenuItem>
                              <MenuItem value="TD Bank" onClick={()=>{setactiveBank("TD")}}>TD Bank</MenuItem>
                              <MenuItem value="Royal Bank Of Canada" onClick={()=>{setactiveBank("Royal")}}>Royal Bank Of Canada</MenuItem>
                              <MenuItem value="Bank of Nova Scotia" onClick={()=>{setactiveBank("Nova")}}>Bank of Nova Scotia</MenuItem>
                              <MenuItem value="Bank Of Montreal" onClick={()=>{setactiveBank("Montreal")}}>Bank Of Montreal</MenuItem>
                          </Select>
                      </FormControl>
           ...
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center  ${activeBank === "Canada" ? " bg-green-200 " :" "} `}><img src={`images/bankofcanada.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
                        
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${activeBank === "TD" ? " bg-green-200 " :" "} `}><img src={`images/td.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${activeBank === "Royal" ? " bg-green-200 " :" "} `}><img src={`images/rbc.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${activeBank === "Nova" ? " bg-green-200 " :" "} `}><img src={`images/scoti.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${activeBank === "Montreal" ? " bg-green-200 " :" "} `}><img src={`images/m.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
