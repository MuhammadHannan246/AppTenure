        ...
        <div className="flex h-full w-full">
          <div className='w-1/3 h-full mt-6' style={{ boxShadow: '5px 0 10px rgba(0, 0, 0, 0.1'}}>
            <a onClick={accSett} className={`${selectedCategory === 'accountSetting'
              ...
              } mb-3 cursor-pointer p-4 flex`} style={{ color: "#5A7894" }}><img src="icons/user.svg" className='mr-5' alt="" />Account Setting <img src="icons/chevron_right.svg" className='ml-36' alt="" /></a>
            <h4 onClick={passSett} className={`${selectedCategory === 'passwordSetting'
              ? 'bg-yellow-400 text-white'
              : 'hover:bg-yellow-400 hover:text-white'
              } mb-3 cursor-pointer p-4 flex`} style={{ color: "#5A7894" }}><img src="icons/password.svg" className='mr-5' alt="" />Change password <img src="icons/chevron_right.svg" className='ml-32' alt="" /></h4>
            <h4 className={`${selectedCategory === 'customerSupport'
              ? 'bg-yellow-400 text-white'
              : 'hover:bg-yellow-400 hover:text-white'
              } mb-3 cursor-pointer p-4 flex`} style={{ color: "#5A7894" }}><img src="icons/contact_support.svg" className='mr-5' alt="" />Contact support <img src="icons/chevron_right.svg" className='ml-36' alt="" /></h4>
          </div>

          {accDivShown && <div className='ml-10 mt-8 w-full' style={{ color: "#5A7894" }}>
            <div className="flex w-11/12 justify-between">
              <h4 className='text-xl text-black'>Account Info</h4>
              <button onClick={EditInfo} className='flex  p-2 rounded-lg' style={{ border: "1px solid #38857b", color: "#38857b", fontWeight: "700" }}><img src="icons/edit.svg" className='mr-2' alt="" />Edit Account Info</button>
            </div>
            {InfoFormShown && <>
            ...
            style={{ border: formik2.touched.currentPass && formik2.errors.currentPass ? '1px solid red' : '' }}
              ...
              <button type="button" className='relative w-fit' style={{left:'97%',transform:'translateY(-40px)'}} onClick={togglePassword1}>
                {typePassword1 === 'password' ? (
                  <img alt="eye" src="icons/eye_closed.svg" />
                ) : (
                  <img alt="eye" src="icons/eye_open.svg" />
                )}
              </button>
