    ...
    <>
      ...
      {shouldShowMain && (
        <tbody className="gap-x-7 gap-y-7">
          <tr className="bg-white-600 custom_border" >
            <td className="flex px-4" style={{ alignItems: 'center' }}>
              <img src={`icons/${props.img}`} className="mr-3" alt="" style={{ width: '40px' }} />
              <h5 className="text-start cursor-pointer">{props.name}</h5>
            </td>
            <td
            ...
            <td>
              <div style={{ backgroundColor: '#DCEDF6', width: '80%' }} className="h-4 rounded-3xl">
                <div
            ...
            <td className="custom_icons_grid">
              <Tippy content={<span>Make a contribution</span>} placement="bottom" animation="scale">
                <a
                  onClick={handleOpen}
                  className="rounded  button cursor-pointer custom_icon_box"
                  style={{ backgroundColor: 'rgba(28, 92, 95, 1)' }}
                >
                  <img
                    src="icons/gift.svg"
                    style={{ filter: 'brightness(900%)', padding: '2px' }}
              ...
              <Tippy content={<span>Remove Employee</span>} placement="bottom" animation="scale">
                <a
                  ...
                  className="cross rounded hover:bg-red-100 cursor-pointer custom_icon_box"
                >
                  <img src="icons/close.svg" className="custom_icon" alt="" />
                </a>
              </Tippy>
            </td>
          </tr>
          <div className='' style={{marginTop:'8px'}}></div>
            ...
            <Box sx={style}>
              <div className="py-4">
                <div className="flex justify-between text-start">
                  ...
                  <img src="icons/cross69.svg" onClick={handleClose} className="cursor-pointer" alt="" />
                </div>
            ...
            <Box sx={style2}>
              <div className="py-4">
                <div className="flex justify-end">
                  <img src="icons/cross69.svg" onClick={handleClose2} className="cursor-pointer" alt="" />
                </div>
      ...
      {shouldShowReceiver && (
        <tbody className="gap-x-7 gap-y-7">
          <tr className="bg-white-600 custom_border p-4" >
            <td className="flex px-4" style={{ alignItems: 'center' }}>
              <img src={`icons/${props.img}`} className="mr-3" alt="" style={{ width: '40px' }} />
              <h5 className="text-start cursor-pointer">{props.name}</h5>
            </td>
            <td>
              <div style={{ backgroundColor: '#DCEDF6', width: '100%' }} className="h-5 m-auto rounded-3xl">
                <div
                  className=" rounded-2xl h-full"
                  style={{ backgroundColor: '#38857B', width: props.progress }}
                ></div>
            ...
            <td style={{ color: '#25384D' , paddingLeft: '50px'}} className=" text-md w-1/4 text-start">
              {props.goal}
            </td>
            <td className="custom_icons_grid">
              <Tippy content={<span>Make a contribution</span>} placement="bottom" animation="scale">
        ...
        <tbody className="gap-x-7 gap-y-7">
          <tr className="bg-white-600 custom_border">
            <td className="flex p-4 w-1/3">
              <img src={`icons/${props.img}`} className="mr-3" alt="" />
            ...
            <td className="flex justify-start">
              <img src={`icons/${props.catimg}`} alt="" />
      ...
      {shouldShowDealsRows && (
        <tbody className="gap-x-7 gap-y-7 cursor-pointer">
          <tr
          ...
          <tr className="bg-white-600 shadow-lg rounded-xl mt-5  transition-colors hover:bg-yellow-500 ">
            ...
            <td className="flex justify-center">
              ...
              <Tippy content={<span>Remove Employee</span>} placement="bottom" animation="scale">
                ...
                >
                  <img src="icons/close.svg" className="p-1 px-2 py-2" alt="" />
                </a>
              </Tippy>
            </td>
          </tr>
