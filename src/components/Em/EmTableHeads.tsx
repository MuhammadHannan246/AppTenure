  ...
  return (
    <>
      ...
      {shouldShowMain && (
        <>
          <thead>
            <tr className="bg-white-600  my-4">
              <th className="text-start w-1/4 py-4 px-1" style={{ color: '#25384D', width: '30%' }}>
                {Employee}
              </th>
              <th className="flex justify-start mt-4 saveGoals cursor-pointer " style={{ color: '#25384D', width: '50%' }}>
                <a>
                  <Tippy
                  ...
                  >
                    <span className="flex">
                      {' '}
                      {Savinggoals}
                      <img src="icons/i.svg" className="ml-2" alt="" />
                    </span>
                  </Tippy>
                </a>
              </th>

              <th className="" style={{ color: '#25384D' , textAlign: 'left', width: '15%'}}>
                {Overallprogress}
              </th>
        ...
        <>
          <thead>
            <tr className="bg-white-600  my-4">
              ...
              <th className="text-start w-1/4" style={{ color: '#25384D' }}>
                {Overallprogress}
              </th>
              <th className="w-1/4 text-start" style={{ color: '#25384D' , paddingLeft: '50px'}}>
