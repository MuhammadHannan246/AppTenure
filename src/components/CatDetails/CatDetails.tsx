    ...
    <div className="w-full ms-5">
      <div className="text-start ms-4 mt-5">
        <div className="flex" style={{ color: '#25384D' }}>
         <Link to="/Deals"><img src="icons/arrow_left.svg" className="mr-4" alt="" /></Link> 
          <h1>{_prop?.item?.brand}</h1>
        </div>
        <div className="flex mt-5">
          <div className="flex flex-col" style={{ color: '#25384D' }}>
            <img src={`icons/${_prop?.item?.img}`} alt="" />
            <h4 className="mt-4">Available</h4>
          </div>
          <div className="ms-5">
            <h3 style={{ color: '#25384D' }}>{_prop?.item?.brand}</h3>
            <div className="flex mt-4">
              <img src="icons/map_arrow.svg" className="mr-5" alt="" />
